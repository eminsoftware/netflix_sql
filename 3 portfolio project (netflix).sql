...
-- splits contents of duration by space (ex: 90 min into 90)
-- takes the first part (ex: 90), converts it into integer
...
/*
ilike '%Kill%' - match anything that contains the letters Kill (Kill, killer, KILLING, Skill, Unskilled ,The Kill Code ...)
~* '\mKill\M' - match only the word Kill, exactly and completely, case regardless (kill, Kill., Kill!, The Kill happened ...)
~* '\mKill' - match any word with "Kill", regardless of case. (Kill, killer, killing, killzone, KILLLER ...)
*/
